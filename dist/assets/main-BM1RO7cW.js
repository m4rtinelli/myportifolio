import"./modulepreload-polyfill-B5Qt9EMX.js";const Vc=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:jn,depthTest:!1,depthWrite:!1})}function Jl(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:jn,depthTest:!1,depthWrite:!1})}function Ql(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$o(),fragmentShader:`
...
#define LOW_PRECISION`),t}function ng(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Hc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Ih?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function ig(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ur:case hr:t="ENVMAP_TYPE_CUBE";break;case Xs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rg(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case hr:t="ENVMAP_MODE_REFRACTION";break}return t}function sg(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case kc:t="ENVMAP_BLENDING_MULTIPLY";break;case of:t="ENVMAP_BLENDING_MIX";break;case lf:t="ENVMAP_BLENDING_ADD";break}return t}function ag(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function og(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=ng(e),c=ig(e),u=rg(e),h=sg(e),f=ag(e),m=K_(e),g=$_(s),_=i.createProgram();let d,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Cr).join(`
`)),a=yo(a),a=cc(a,e),a=uc(a,e),o=yo(o),o=cc(o,e),o=uc(o,e),a=hc(a),o=hc(o),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const x=E+d+a,T=E+p+o,R=oc(i,i.VERTEX_SHADER,x),A=oc(i,i.FRAGMENT_SHADER,T);i.attachShader(_,R),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(L){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),N=i.getShaderInfoLog(R).trim(),G=i.getShaderInfoLog(A).trim();let X=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,R,A);else{const Y=lc(i,R,"vertex"),k=lc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
*/var Ke={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},mr={duration:.5,overwrite:!1,delay:0},Zo,Se,jt,Sn=1e8,Ae=1/Sn,To=Math.PI*2,Gg=To/4,Wg=0,Ru=Math.sqrt,Xg=Math.cos,qg=Math.sin,ve=function(t){return typeof t=="string"},re=function(t){return typeof t=="function"},On=function(t){return typeof t=="number"},jo=function(t){return typeof t>"u"},En=function(t){return typeof t=="object"},Ie=function(t){return t!==!1},Jo=function(){return typeof window<"u"},ys=function(t){return re(t)||ve(t)},Cu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},be=Array.isArray,Ao=/(?:-?\.?\d|\.)+/gi,Pu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,nr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Ia=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Lu=/[+-]=-?[.\d]+/,Du=/[^,'"\[\]\s]+/gi,Yg=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Qt,mn,bo,Qo,$e={},Bs={},Uu,Iu=function(t){return(Bs=_r(t,$e))&&Be},tl=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Fr=function(t,e){return!e&&console.warn(t)},Nu=function(t,e){return t&&($e[t]=e)&&Bs&&(Bs[t]=e)||$e},Or=function(){return 0},Kg={suppressEvents:!0,isStart:!0,kill:!1},Cs={suppressEvents:!0,kill:!1},$g={suppressEvents:!0},el={},Qn=[],wo={},Fu,We={},Na={},yc=30,Ps=[],nl="",il=function(t){var e=t[0],n,i;if(En(e)||re(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=Ps.length;i--&&!Ps[i].targetTest(e););n=Ps[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new ah(t[i],n)))||t.splice(i,1);return t},Ai=function(t){return t._gsap||il(en(t))[0]._gsap},Ou=function(t,e,n){return(n=t[e])&&re(n)?t[e]():jo(n)&&t.getAttribute&&t.getAttribute(e)||n},Ne=function(t,e){return(t=t.split(",")).forEach(e)||t},se=function(t){return Math.round(t*1e5)/1e5||0},fe=function(t){return Math.round(t*1e7)/1e7||0},or=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},Zg=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},zs=function(){var t=Qn.length,e=Qn.slice(0),n,i;for(wo={},Qn.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},rl=function(t){return!!(t._initted||t._startAt||t.add)},Bu=function(t,e,n,i){Qn.length&&!Se&&zs(),t.render(e,n,!!(Se&&e<0&&rl(t))),Qn.length&&!Se&&zs()},zu=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(Du).length<2?e:ve(t)?t.trim():t},Vu=function(t){return t},Ze=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},jg=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},_r=function(t,e){for(var n in e)t[n]=e[n];return t},Ec=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=En(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Vs=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Dr=function(t){var e=t.parent||Qt,n=t.keyframes?jg(be(t.keyframes)):Ze;if(Ie(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},Jg=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},Hu=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},$s=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},ni=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},bi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},Qg=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},Ro=function(t,e,n,i){return t._startAt&&(Se?t._startAt.revert(Cs):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},t0=function r(t){return!t||t._ts&&r(t.parent)},Tc=function(t){return t._repeat?gr(t._tTime,t=t.duration()+t._rDelay)*t:0},gr=function(t,e){var n=Math.floor(t=fe(t/e));return t&&n===t?n-1:n},Hs=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Zs=function(t){return t._end=fe(t._start+(t._tDur/Math.abs(t._ts||t._rts||Ae)||0))},js=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=fe(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Zs(t),n._dirty||bi(n,t)),t},ku=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=Hs(t.rawTime(),e),(!e._dur||$r(0,e.totalDuration(),n)-e._tTime>Ae)&&e.render(n,!0)),bi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-1e-8}},vn=function(t,e,n,i){return e.parent&&ni(e),e._start=fe((On(n)?n:n||t!==Qt?Qe(t,n,e):t._time)+e._delay),e._end=fe(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),Hu(t,e,"_first","_last",t._sort?"_start":0),Co(e)||(t._recent=e),i||ku(t,e),t._ts<0&&js(t,t._tTime),t},Gu=function(t,e){return($e.ScrollTrigger||tl("scrollTrigger",e))&&$e.ScrollTrigger.create(e,t)},Wu=function(t,e,n,i,s){if(al(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!Se&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&Fu!==Xe.frame)return Qn.push(t),t._lazy=[s,i],1},e0=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},Co=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},n0=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&e0(t)&&!(!t._initted&&Co(t))||(t._ts<0||t._dp._ts<0)&&!Co(t))?0:1,o=t._rDelay,l=0,c,u,h;if(o&&t._repeat&&(l=$r(0,t._tDur,e),u=gr(l,o),t._yoyo&&u&1&&(a=1-a),u!==gr(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||Se||i||t._zTime===Ae||!e&&t._zTime){if(!t._initted&&Wu(t,e,i,n,l))return;for(h=t._zTime,t._zTime=e||(n?Ae:0),n||(n=e&&!h),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&Ro(t,e,n,!0),t._onUpdate&&!n&&Ye(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&Ye(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&ni(t,1),!n&&!Se&&(Ye(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},i0=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},vr=function(t,e,n,i){var s=t._repeat,a=fe(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:fe(a*(s+1)+t._rDelay*s):a,o>0&&!i&&js(t,t._tTime=t._tDur*o),t.parent&&Zs(t),n||bi(t.parent,t),t},Ac=function(t){return t instanceof Ce?bi(t):vr(t,t._dur)},r0={_start:0,endTime:Or,totalDuration:Or},Qe=function r(t,e,n){var i=t.labels,s=t._recent||r0,a=t.duration()>=Sn?s.endTime(!1):t._dur,o,l,c;return ve(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(be(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Ur=function(t,e,n){var i=On(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Ie(l.vars.inherit)&&l.parent;a.immediateRender=Ie(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new he(e[0],a,e[s+1])},si=function(t,e){return t||t===0?e(t):e},$r=function(t,e,n){return n<t?t:n>e?e:n},Te=function(t,e){return!ve(t)||!(e=Yg.exec(t))?"":e[1]},s0=function(t,e,n){return si(n,function(i){return $r(t,e,i)})},Po=[].slice,Xu=function(t,e){return t&&En(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&En(t[0]))&&!t.nodeType&&t!==mn},a0=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return ve(i)&&!e||Xu(i,1)?(s=n).push.apply(s,en(i)):n.push(i)})||n},en=function(t,e,n){return jt&&!e&&jt.selector?jt.selector(t):ve(t)&&!n&&(bo||!xr())?Po.call((e||Qo).querySelectorAll(t),0):be(t)?a0(t,n):Xu(t)?Po.call(t,0):t?[t]:[]},Lo=function(t){return t=en(t)[0]||Fr("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return en(e,n.querySelectorAll?n:n===t?Fr("Invalid scope")||Qo.createElement("div"):t)}},qu=function(t){return t.sort(function(){return .5-Math.random()})},Yu=function(t){if(re(t))return t;var e=En(t)?t:{each:t},n=wi(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,u=i,h=i;return ve(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],h=i[1]),function(f,m,g){var _=(g||e).length,d=a[_],p,E,x,T,R,A,b,P,v;if(!d){if(v=e.grid==="auto"?0:(e.grid||[1,Sn])[1],!v){for(b=-1e8;b<(b=g[v++].getBoundingClientRect().left)&&v<_;);v<_&&v--}for(d=a[_]=[],p=l?Math.min(v,_)*u-.5:i%v,E=v===Sn?0:l?_*h/v-.5:i/v|0,b=0,P=Sn,A=0;A<_;A++)x=A%v-p,T=E-(A/v|0),d[A]=R=c?Math.abs(c==="y"?T:x):Ru(x*x+T*T),R>b&&(b=R),R<P&&(P=R);i==="random"&&qu(d),d.max=b-P,d.min=P,d.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),d.b=_<0?s-_:s,d.u=Te(e.amount||e.each)||0,n=n&&_<0?ih(n):n}return _=(d[f]-d.min)/d.max||0,fe(d.b+(n?n(_):_)*d.v)+d.u}},Do=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=fe(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(On(n)?0:Te(n))}},Ku=function(t,e){var n=be(t),i,s;return!n&&En(t)&&(i=n=t.radius||Sn,t.values?(t=en(t.values),(s=!On(t[0]))&&(i*=i)):t=Do(t.increment)),si(e,n?re(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=Sn,u=0,h=t.length,f,m;h--;)s?(f=t[h].x-o,m=t[h].y-l,f=f*f+m*m):f=Math.abs(t[h]-o),f<c&&(c=f,u=h);return u=!i||c<=i?t[u]:a,s||u===a||On(a)?u:u+Te(a)}:Do(t))},$u=function(t,e,n,i){return si(be(t)?!e:n===!0?!!(n=0):!i,function(){return be(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},o0=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},l0=function(t,e){return function(n){return t(parseFloat(n))+(e||Te(n))}},c0=function(t,e,n){return ju(t,e,0,1,n)},Zu=function(t,e,n){return si(n,function(i){return t[~~e(i)]})},u0=function r(t,e,n){var i=e-t;return be(t)?Zu(t,r(0,t.length),e):si(n,function(s){return(i+(s-t)%i)%i+t})},h0=function r(t,e,n){var i=e-t,s=i*2;return be(t)?Zu(t,r(0,t.length-1),e):si(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Br=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?Du:Ao),n+=t.substr(e,i-e)+$u(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},ju=function(t,e,n,i,s){var a=e-t,o=i-n;return si(s,function(l){return n+((l-t)/a*o||0)})},f0=function r(t,e,n,i){var s=isNaN(t+e)?0:function(m){return(1-m)*t+m*e};if(!s){var a=ve(t),o={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(be(t)&&!be(e)){for(u=[],h=t.length,f=h-2,c=1;c<h;c++)u.push(r(t[c-1],t[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=e}else i||(t=_r(be(t)?[]:{},t));if(!u){for(l in e)sl.call(o,t,l,"get",e[l]);s=function(g){return cl(g,o)||(a?t.p:t)}}}return si(n,s)},bc=function(t,e,n){var i=t.labels,s=Sn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Ye=function(t,e,n){var i=t.vars,s=i[e],a=jt,o=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&Qn.length&&zs(),o&&(jt=o),u=l?s.apply(c,l):s.call(c),jt=a,u},Pr=function(t){return ni(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Se),t.progress()<1&&Ye(t,"onInterrupt"),t},ir,Ju=[],Qu=function(t){if(t)if(t=!t.name&&t.default||t,Jo()||t.headless){var e=t.name,n=re(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Or,render:cl,add:sl,kill:R0,modifier:w0,rawVars:0},a={targetTest:0,get:0,getSetter:ll,aliases:{},register:0};if(xr(),t!==i){if(We[e])return;Ze(i,Ze(Vs(t,s),a)),_r(i.prototype,_r(s,Vs(t,a))),We[i.prop=e]=i,t.targetTest&&(Ps.push(i),el[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}Nu(e,i),t.register&&t.register(Be,i,Fe)}else Ju.push(t)},$t=255,Lr={aqua:[0,$t,$t],lime:[0,$t,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,$t],navy:[0,0,128],white:[$t,$t,$t],olive:[128,128,0],yellow:[$t,$t,0],orange:[$t,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[$t,0,0],pink:[$t,192,203],cyan:[0,$t,$t],transparent:[$t,$t,$t,0]},Fa=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*$t+.5|0},th=function(t,e,n){var i=t?On(t)?[t>>16,t>>8&$t,t&$t]:0:Lr.black,s,a,o,l,c,u,h,f,m,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Lr[t])i=Lr[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&$t,i&$t,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&$t,t&$t]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(Ao),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Fa(l+1/3,s,a),i[1]=Fa(l,s,a),i[2]=Fa(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(Pu),n&&i.length<4&&(i[3]=1),i}else i=t.match(Ao)||Lr.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/$t,a=i[1]/$t,o=i[2]/$t,h=Math.max(s,a,o),f=Math.min(s,a,o),u=(h+f)/2,h===f?l=c=0:(m=h-f,c=u>.5?m/(2-h-f):m/(h+f),l=h===s?(a-o)/m+(a<o?6:0):h===a?(o-s)/m+2:(s-a)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},eh=function(t){var e=[],n=[],i=-1;return t.split(ti).forEach(function(s){var a=s.match(nr)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},wc=function(t,e,n){var i="",s=(t+i).match(ti),a=e?"hsla(":"rgba(",o=0,l,c,u,h;if(!s)return t;if(s=s.map(function(f){return(f=th(f,e,1))&&a+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=eh(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(ti,"1").split(nr),h=c.length-1;o<h;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(ti),h=c.length-1;o<h;o++)i+=c[o]+s[o];return i+c[h]},ti=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Lr)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),d0=/hsl[a]?\(/,nh=function(t){var e=t.join(" "),n;if(ti.lastIndex=0,ti.test(e))return n=d0.test(e),t[1]=wc(t[1],n),t[0]=wc(t[0],n,eh(t[1])),!0},zr,Xe=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,h,f,m,g=function _(d){var p=r()-i,E=d===!0,x,T,R,A;if((p>t||p<0)&&(n+=p-e),i+=p,R=i-n,x=R-a,(x>0||E)&&(A=++h.frame,f=R-h.time*1e3,h.time=R=R/1e3,a+=x+(x>=s?4:s-x),T=1),E||(l=c(_)),T)for(m=0;m<o.length;m++)o[m](R,f,A,d)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(d){return f/(1e3/(d||60))},wake:function(){Uu&&(!bo&&Jo()&&(mn=bo=window,Qo=mn.document||{},$e.gsap=Be,(mn.gsapVersions||(mn.gsapVersions=[])).push(Be.version),Iu(Bs||mn.GreenSockGlobals||!mn.gsap&&mn||{}),Ju.forEach(Qu)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(d){return setTimeout(d,a-h.time*1e3+1|0)},zr=1,g(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),zr=0,c=Or},lagSmoothing:function(d,p){t=d||1/0,e=Math.min(p||33,t)},fps:function(d){s=1e3/(d||240),a=h.time*1e3+s},add:function(d,p,E){var x=p?function(T,R,A,b){d(T,R,A,b),h.remove(x)}:d;return h.remove(d),o[E?"unshift":"push"](x),xr(),x},remove:function(d,p){~(p=o.indexOf(d))&&o.splice(p,1)&&m>=p&&m--},_listeners:o},h}(),xr=function(){return!zr&&Xe.wake()},Nt={},p0=/^[\d.\-M][\d.\-,\s]/,m0=/["']/g,_0=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(m0,"").trim():+c,i=l.substr(o+1).trim();return e},g0=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},v0=function(t){var e=(t+"").split("("),n=Nt[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[_0(e[1])]:g0(t).split(",").map(zu)):Nt._CE&&p0.test(t)?Nt._CE("",t):n},ih=function(t){return function(e){return 1-t(1-e)}},rh=function r(t,e){for(var n=t._first,i;n;)n instanceof Ce?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},wi=function(t,e){return t&&(re(t)?t:Nt[t]||v0(t))||e},Ui=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return Ne(t,function(o){Nt[o]=$e[o]=s,Nt[a=o.toLowerCase()]=n;for(var l in s)Nt[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Nt[o+"."+l]=s[l]}),s},sh=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},Oa=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/To*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*qg((u-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:sh(o);return s=To/s,l.config=function(c,u){return r(t,c,u)},l},Ba=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:sh(n);return i.config=function(s){return r(t,s)},i};Ne("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;Ui(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Nt.Linear.easeNone=Nt.none=Nt.Linear.easeIn;Ui("Elastic",Oa("in"),Oa("out"),Oa());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};Ui("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);Ui("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)});Ui("Circ",function(r){return-(Ru(1-r*r)-1)});Ui("Sine",function(r){return r===1?1:-Xg(r*Gg)+1});Ui("Back",Ba("in"),Ba("out"),Ba());Nt.SteppedEase=Nt.steps=$e.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-Ae;return function(o){return((i*$r(0,a,o)|0)+s)*n}}};mr.ease=Nt["quad.out"];Ne("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return nl+=r+","+r+"Params,"});var ah=function(t,e){this.id=Wg++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:Ou,this.set=e?e.getSetter:ll},Vr=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,vr(this,+e.duration,1,1),this.data=e.data,jt&&(this._ctx=jt,jt.data.push(this)),zr||Xe.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,vr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(xr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(js(this,n),!s._dp||s.parent||ku(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&vn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Ae||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Bu(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Tc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Tc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?gr(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-1e-8?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Hs(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-1e-8?0:this._rts,this.totalTime($r(-Math.abs(this._delay),this.totalDuration(),s),i!==!1),Zs(this),Qg(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(xr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Ae&&(this._tTime-=Ae)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&vn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Ie(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Hs(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=$g);var i=Se;return Se=n,rl(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Se=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Ac(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Ac(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(Qe(this,n),Ie(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Ie(i)),this._dur||(this._zTime=-1e-8),this},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-1e-8:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-1e-8,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-Ae)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=re(n)?n:Vu,o=function(){var c=i.then;i.then=null,re(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Pr(this)},r}();Ze(Vr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-1e-8,_prom:0,_ps:!1,_rts:1});var Ce=function(r){wu(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Ie(n.sortChildren),Qt&&vn(n.parent||Qt,Ln(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&Gu(Ln(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Ur(0,arguments,this),this},e.from=function(i,s,a){return Ur(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Ur(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Dr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new he(i,s,Qe(this,a),1),this},e.call=function(i,s,a){return vn(this,he.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new he(i,a,Qe(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,Dr(a).immediateRender=Ie(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},e.staggerFromTo=function(i,s,a,o,l,c,u,h){return o.startAt=a,Dr(o).immediateRender=Ie(o.immediateRender),this.staggerTo(i,s,o,l,c,u,h)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:fe(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,m,g,_,d,p,E,x,T,R,A,b;if(this!==Qt&&u>l&&i>=0&&(u=l),u!==this._tTime||a||h){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),f=u,T=this._start,x=this._ts,p=!x,h&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,d=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(d*100+i,s,a);if(f=fe(u%d),u===l?(_=this._repeat,f=c):(R=fe(u/d),_=~~R,_&&_===R&&(f=c,_--),f>c&&(f=c)),R=gr(this._tTime,d),!o&&this._tTime&&R!==_&&this._tTime-R*d-this._dur<=0&&(R=_),A&&_&1&&(f=c-f,b=1),_!==R&&!this._lock){var P=A&&R&1,v=P===(A&&_&1);if(_<R&&(P=!P),o=P?0:u%c?c:u,this._lock=1,this.render(o||(b?0:fe(_*d)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&Ye(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),o&&o!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,o=P?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;rh(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(E=i0(this,fe(o),fe(f)),E&&(u-=f-(f=E._start))),this._tTime=u,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&u&&!s&&!R&&(Ye(this,"onStart"),this._tTime!==u))return this;if(f>=o&&i>=0)for(m=this._first;m;){if(g=m._next,(m._act||f>=m._start)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(f-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(f-m._start)*m._ts,s,a),f!==this._time||!this._ts&&!p){E=0,g&&(u+=this._zTime=-1e-8);break}}m=g}else{m=this._last;for(var M=i<0?i:f;m;){if(g=m._prev,(m._act||M<=m._end)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(M-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(M-m._start)*m._ts,s,a||Se&&rl(m)),f!==this._time||!this._ts&&!p){E=0,g&&(u+=this._zTime=M?-1e-8:Ae);break}}m=g}}if(E&&!s&&(this.pause(),E.render(f>=o?0:-1e-8)._zTime=f>=o?1:-1,this._ts))return this._start=T,Zs(this),this.render(i,s,a);this._onUpdate&&!s&&Ye(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(T===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&ni(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&(Ye(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(On(s)||(s=Qe(this,s,i)),!(i instanceof Vr)){if(be(i))return i.forEach(function(o){return a.add(o,s)}),this;if(ve(i))return this.addLabel(i,s);if(re(i))i=he.delayedCall(0,i);else return this}return this!==i?vn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-1e8);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof he?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return ve(i)?this.removeLabel(i):re(i)?this.killTweensOf(i):(i.parent===this&&$s(this,i),i===this._recent&&(this._recent=this._last),bi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=fe(Xe.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=Qe(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=he.delayedCall(0,s||Or,a);return o.data="isPause",this._hasPause=1,vn(this,o,Qe(this,i))},e.removePause=function(i){var s=this._first;for(i=Qe(this,i);s;)s._start===i&&s.data==="isPause"&&ni(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Kn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=en(i),l=this._first,c=On(s),u;l;)l instanceof he?Zg(l._targets,o)&&(c?(!Kn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=Qe(a,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,m,g=he.to(a,Ze({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||Ae,onStart:function(){if(a.pause(),!m){var d=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==d&&vr(g,d,0,1).render(g._time,!0,!0),m=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,Ze({startAt:{time:Qe(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),bc(this,Qe(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),bc(this,Qe(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Ae)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return bi(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),bi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=Sn,c,u,h;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(h=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,vn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!h&&!a._dp||h&&h.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;vr(a,a===Qt&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(Qt._ts&&(Bu(Qt,Hs(i,Qt)),Fu=Xe.frame),Xe.frame>=yc){yc+=Ke.autoSleep||120;var s=Qt._first;if((!s||!s._ts)&&Ke.autoSleep&&Xe._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Xe.sleep()}}},t}(Vr);Ze(Ce.prototype,{_lock:0,_hasPause:0,_forcing:0});var x0=function(t,e,n,i,s,a,o){var l=new Fe(this._pt,t,e,0,1,fh,null,s),c=0,u=0,h,f,m,g,_,d,p,E;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=Br(i)),a&&(E=[n,i],a(E,t,e),n=E[0],i=E[1]),f=n.match(Ia)||[];h=Ia.exec(i);)g=h[0],_=i.substring(c,h.index),m?m=(m+1)%5:_.substr(-5)==="rgba("&&(m=1),g!==f[u++]&&(d=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:d,c:g.charAt(1)==="="?or(d,g)-d:parseFloat(g)-d,m:m&&m<4?Math.round:0},c=Ia.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Lu.test(i)||p)&&(l.e=0),this._pt=l,l},sl=function(t,e,n,i,s,a,o,l,c,u){re(i)&&(i=i(s||0,t,a));var h=t[e],f=n!=="get"?n:re(h)?c?t[e.indexOf("set")||!re(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():h,m=re(h)?c?T0:uh:ol,g;if(ve(i)&&(~i.indexOf("random(")&&(i=Br(i)),i.charAt(1)==="="&&(g=or(f,i)+(Te(f)||0),(g||g===0)&&(i=g))),!u||f!==i||Uo)return!isNaN(f*i)&&i!==""?(g=new Fe(this._pt,t,e,+f||0,i-(f||0),typeof h=="boolean"?b0:hh,0,m),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!h&&!(e in t)&&tl(e,i),x0.call(this,t,e,f,i,m,l||Ke.stringFilter,c))},M0=function(t,e,n,i,s){if(re(t)&&(t=Ir(t,s,e,n,i)),!En(t)||t.style&&t.nodeType||be(t)||Cu(t))return ve(t)?Ir(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=Ir(t[o],s,e,n,i);return a},oh=function(t,e,n,i,s,a){var o,l,c,u;if(We[t]&&(o=new We[t]).init(s,o.rawVars?e[t]:M0(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Fe(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==ir))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},Kn,Uo,al=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,f=i.keyframes,m=i.autoRevert,g=t._dur,_=t._startAt,d=t._targets,p=t.parent,E=p&&p.data==="nested"?p.vars.targets:d,x=t._overwrite==="auto"&&!Zo,T=t.timeline,R,A,b,P,v,M,L,z,N,G,X,H,Y;if(T&&(!f||!s)&&(s="none"),t._ease=wi(s,mr.ease),t._yEase=h?ih(wi(h===!0?s:h,mr.ease)):0,h&&t._yoyo&&!t._repeat&&(h=t._yEase,t._yEase=t._ease,t._ease=h),t._from=!T&&!!i.runBackwards,!T||f&&!i.stagger){if(z=d[0]?Ai(d[0]).harness:0,H=z&&i[z.prop],R=Vs(i,el),_&&(_._zTime<0&&_.progress(1),e<0&&u&&o&&!m?_.render(-1,!0):_.revert(u&&g?Cs:Kg),_._lazy=0),a){if(ni(t._startAt=he.set(d,Ze({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!_&&Ie(l),startAt:null,delay:0,onUpdate:c&&function(){return Ye(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Se||!o&&!m)&&t._startAt.revert(Cs),o&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(u&&g&&!_){if(e&&(o=!1),b=Ze({overwrite:!1,data:"isFromStart",lazy:o&&!_&&Ie(l),immediateRender:o,stagger:0,parent:p},R),H&&(b[z.prop]=H),ni(t._startAt=he.set(d,b)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Se?t._startAt.revert(Cs):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,Ae,Ae);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&Ie(l)||l&&!g,A=0;A<d.length;A++){if(v=d[A],L=v._gsap||il(d)[A]._gsap,t._ptLookup[A]=G={},wo[L.id]&&Qn.length&&zs(),X=E===d?A:E.indexOf(v),z&&(N=new z).init(v,H||R,t,X,E)!==!1&&(t._pt=P=new Fe(t._pt,v,N.name,0,1,N.render,N,0,N.priority),N._props.forEach(function(k){G[k]=P}),N.priority&&(M=1)),!z||H)for(b in R)We[b]&&(N=oh(b,R,t,X,v,E))?N.priority&&(M=1):G[b]=P=sl.call(t,v,b,"get",R[b],X,E,0,i.stringFilter);t._op&&t._op[A]&&t.kill(v,t._op[A]),x&&t._pt&&(Kn=t,Qt.killTweensOf(v,G,t.globalTime(e)),Y=!t.parent,Kn=0),t._pt&&l&&(wo[L.id]=1)}M&&dh(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!Y,f&&e<=0&&T.render(Sn,!0,!0)},S0=function(t,e,n,i,s,a,o,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],u,h,f,m;if(!c)for(c=t._ptCache[e]=[],f=t._ptLookup,m=t._targets.length;m--;){if(u=f[m][e],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==e&&u.fp!==e;)u=u._next;if(!u)return Uo=1,t.vars[e]="+=0",al(t,o),Uo=0,l?Fr(e+" not eligible for reset"):1;c.push(u)}for(m=c.length;m--;)h=c[m],u=h._pt||h,u.s=(i||i===0)&&!s?i:u.s+(i||0)+a*u.c,u.c=n-u.s,h.e&&(h.e=se(n)+Te(h.e)),h.b&&(h.b=u.s+Te(h.b))},y0=function(t,e){var n=t[0]?Ai(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=_r({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},E0=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(be(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},Ir=function(t,e,n,i,s){return re(t)?t.call(e,n,i,s):ve(t)&&~t.indexOf("random(")?Br(t):t},lh=nl+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",ch={};Ne(lh+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return ch[r]=1});var he=function(r){wu(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Dr(i))||this;var l=o.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,m=l.overwrite,g=l.keyframes,_=l.defaults,d=l.scrollTrigger,p=l.yoyoEase,E=i.parent||Qt,x=(be(n)||Cu(n)?On(n[0]):"length"in i)?[n]:en(n),T,R,A,b,P,v,M,L;if(o._targets=x.length?il(x):Fr("GSAP target "+n+" not found. https://gsap.com",!Ke.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=m,g||f||ys(c)||ys(u)){if(i=o.vars,T=o.timeline=new Ce({data:"nested",defaults:_||{},targets:E&&E.data==="nested"?E.vars.targets:x}),T.kill(),T.parent=T._dp=Ln(o),T._start=0,f||ys(c)||ys(u)){if(b=x.length,M=f&&Yu(f),En(f))for(P in f)~lh.indexOf(P)&&(L||(L={}),L[P]=f[P]);for(R=0;R<b;R++)A=Vs(i,ch),A.stagger=0,p&&(A.yoyoEase=p),L&&_r(A,L),v=x[R],A.duration=+Ir(c,Ln(o),R,v,x),A.delay=(+Ir(u,Ln(o),R,v,x)||0)-o._delay,!f&&b===1&&A.delay&&(o._delay=u=A.delay,o._start+=u,A.delay=0),T.to(v,A,M?M(R,v,x):0),T._ease=Nt.none;T.duration()?c=u=0:o.timeline=0}else if(g){Dr(Ze(T.vars.defaults,{ease:"none"})),T._ease=wi(g.ease||i.ease||"none");var z=0,N,G,X;if(be(g))g.forEach(function(H){return T.to(x,H,">")}),T.duration();else{A={};for(P in g)P==="ease"||P==="easeEach"||E0(P,g[P],A,g.easeEach);for(P in A)for(N=A[P].sort(function(H,Y){return H.t-Y.t}),z=0,R=0;R<N.length;R++)G=N[R],X={ease:G.e,duration:(G.t-(R?N[R-1].t:0))/100*c},X[P]=G.v,T.to(x,X,z),z+=X.duration;T.duration()<c&&T.to({},{duration:c-T.duration()})}}c||o.duration(c=T.duration())}else o.timeline=0;return m===!0&&!Zo&&(Kn=Ln(o),Qt.killTweensOf(x),Kn=0),vn(E,Ln(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(h||!c&&!g&&o._start===fe(E._time)&&Ie(h)&&t0(Ln(o))&&E.data!=="nested")&&(o._tTime=-1e-8,o.render(Math.max(0,-u)||0)),d&&Gu(Ln(o),d),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-Ae&&!u?l:i<Ae?0:i,f,m,g,_,d,p,E,x,T;if(!c)n0(this,i,s,a);else if(h!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(f=h,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(f=fe(h%_),h===l?(g=this._repeat,f=c):(d=fe(h/_),g=~~d,g&&g===d?(f=c,g--):f>c&&(f=c)),p=this._yoyo&&g&1,p&&(T=this._yEase,f=c-f),d=gr(this._tTime,_),f===o&&!a&&this._initted&&g===d)return this._tTime=h,this;g!==d&&(x&&this._yEase&&rh(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&f!==_&&this._initted&&(this._lock=a=1,this.render(fe(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(Wu(this,u?i:f,a,s,h))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==d))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=E=(T||this._ease)(f/c),this._from&&(this.ratio=E=1-E),!o&&h&&!s&&!d&&(Ye(this,"onStart"),this._tTime!==h))return this;for(m=this._pt;m;)m.r(E,m.d),m=m._next;x&&x.render(i<0?i:x._dur*x._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&Ro(this,i,s,a),Ye(this,"onUpdate")),this._repeat&&g!==d&&this.vars.onRepeat&&!s&&this.parent&&Ye(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Ro(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&ni(this,1),!s&&!(u&&!o)&&(h||o||p)&&(Ye(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o,l){zr||Xe.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||al(this,c),u=this._ease(c/this._dur),S0(this,i,s,a,o,u,c,l)?this.resetTo(i,s,a,o,1):(js(this,0),this.parent||Hu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Pr(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Se),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Kn&&Kn.vars.overwrite!==!0)._first||Pr(this),this.parent&&a!==this.timeline.totalDuration()&&vr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?en(i):o,c=this._ptLookup,u=this._pt,h,f,m,g,_,d,p;if((!s||s==="all")&&Jg(o,l))return s==="all"&&(this._pt=0),Pr(this);for(h=this._op=this._op||[],s!=="all"&&(ve(s)&&(_={},Ne(s,function(E){return _[E]=1}),s=_),s=y0(o,s)),p=o.length;p--;)if(~l.indexOf(o[p])){f=c[p],s==="all"?(h[p]=s,g=f,m={}):(m=h[p]=h[p]||{},g=s);for(_ in g)d=f&&f[_],d&&((!("kill"in d.d)||d.d.kill(_)===!0)&&$s(this,d,"_pt"),delete f[_]),m!=="all"&&(m[_]=1)}return this._initted&&!this._pt&&u&&Pr(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Ur(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Ur(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return Qt.killTweensOf(i,s,a)},t}(Vr);Ze(he.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Ne("staggerTo,staggerFrom,staggerFromTo",function(r){he[r]=function(){var t=new Ce,e=Po.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var ol=function(t,e,n){return t[e]=n},uh=function(t,e,n){return t[e](n)},T0=function(t,e,n,i){return t[e](i.fp,n)},A0=function(t,e,n){return t.setAttribute(e,n)},ll=function(t,e){return re(t[e])?uh:jo(t[e])&&t.setAttribute?A0:ol},hh=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},b0=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},fh=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},cl=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},w0=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},R0=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?$s(this,e,"_pt"):e.dep||(n=1),e=i;return!n},C0=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},dh=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Fe=function(){function r(e,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||hh,this.d=l||this,this.set=c||ol,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=C0,this.m=n,this.mt=s,this.tween=i},r}();Ne(nl+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return el[r]=1});$e.TweenMax=$e.TweenLite=he;$e.TimelineLite=$e.TimelineMax=Ce;Qt=new Ce({sortChildren:!1,defaults:mr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ke.stringFilter=nh;var Ri=[],Ls={},P0=[],Rc=0,L0=0,za=function(t){return(Ls[t]||P0).map(function(e){return e()})},Io=function(){var t=Date.now(),e=[];t-Rc>2&&(za("matchMediaInit"),Ri.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=mn.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),za("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),Rc=t,za("matchMedia"))},ph=function(){function r(e,n){this.selector=n&&Lo(n),this.data=[],this._r=[],this.isReverted=!1,this.id=L0++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){re(n)&&(s=i,i=n,n=re);var a=this,o=function(){var c=jt,u=a.selector,h;return c&&c!==a&&c.data.push(a),s&&(a.selector=Lo(s)),jt=a,h=i.apply(a,arguments),re(h)&&a._r.push(h),jt=c,a.selector=u,a.isReverted=!1,h};return a.last=o,n===re?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=jt;jt=null,n(this),jt=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof he&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return o.splice(o.indexOf(u),1)}));for(o.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Ce?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof he)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Ri.length;a--;)Ri[a].id===this.id&&Ri.splice(a,1)},t.revert=function(n){this.kill(n||{})},r}(),D0=function(){function r(e){this.contexts=[],this.scope=e,jt&&jt.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){En(n)||(n={matches:n});var a=new ph(0,s||this.scope),o=a.conditions={},l,c,u;jt&&!a.selector&&(a.selector=jt.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=mn.matchMedia(n[c]),l&&(Ri.indexOf(a)<0&&Ri.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(Io):l.addEventListener("change",Io)));return u&&i(a,function(h){return a.add(null,h)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),ks={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return Qu(i)})},timeline:function(t){return new Ce(t)},getTweensOf:function(t,e){return Qt.getTweensOf(t,e)},getProperty:function(t,e,n,i){ve(t)&&(t=en(t)[0]);var s=Ai(t||{}).get,a=n?Vu:zu;return n==="native"&&(n=""),t&&(e?a((We[e]&&We[e].get||s)(t,e,n,i)):function(o,l,c){return a((We[o]&&We[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=en(t),t.length>1){var i=t.map(function(u){return Be.quickSetter(u,e,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}t=t[0]||{};var a=We[e],o=Ai(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(u){var h=new a;ir._pt=0,h.init(t,n?u+n:u,ir,0,[t]),h.render(1,h),ir._pt&&cl(1,ir)}:o.set(t,l);return a?c:function(u){return c(t,l,n?u+n:u,o,1)}},quickTo:function(t,e,n){var i,s=Be.to(t,Ze((i={},i[e]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(l,c,u){return s.resetTo(e,l,c,u)};return a.tween=s,a},isTweening:function(t){return Qt.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=wi(t.ease,mr.ease)),Ec(mr,t||{})},config:function(t){return Ec(Ke,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!We[o]&&!$e[o]&&Fr(e+" effect requires "+o+" plugin.")}),Na[e]=function(o,l,c){return n(en(o),Ze(l||{},s),c)},a&&(Ce.prototype[e]=function(o,l,c){return this.add(Na[e](o,En(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Nt[t]=wi(e)},parseEase:function(t,e){return arguments.length?wi(t,e):Nt},getById:function(t){return Qt.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Ce(t),i,s;for(n.smoothChildTiming=Ie(t.smoothChildTiming),Qt.remove(n),n._dp=0,n._time=n._tTime=Qt._time,i=Qt._first;i;)s=i._next,(e||!(!i._dur&&i instanceof he&&i.vars.onComplete===i._targets[0]))&&vn(n,i,i._start-i._delay),i=s;return vn(Qt,n,0),n},context:function(t,e){return t?new ph(t,e):jt},matchMedia:function(t){return new D0(t)},matchMediaRefresh:function(){return Ri.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Io()},addEventListener:function(t,e){var n=Ls[t]||(Ls[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=Ls[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:u0,wrapYoyo:h0,distribute:Yu,random:$u,snap:Ku,normalize:c0,getUnit:Te,clamp:s0,splitColor:th,toArray:en,selector:Lo,mapRange:ju,pipe:o0,unitize:l0,interpolate:f0,shuffle:qu},install:Iu,effects:Na,ticker:Xe,updateRoot:Ce.updateRoot,plugins:We,globalTimeline:Qt,core:{PropTween:Fe,globals:Nu,Tween:he,Timeline:Ce,Animation:Vr,getCache:Ai,_removeLinkedListItem:$s,reverting:function(){return Se},context:function(t){return t&&jt&&(jt.data.push(t),t._ctx=jt),jt},suppressOverwrites:function(t){return Zo=t}}};Ne("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return ks[r]=he[r]});Xe.add(Ce.updateRoot);ir=ks.to({},{duration:0});var U0=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},I0=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=U0(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Va=function(t,e){return{name:t,headless:1,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(ve(s)&&(l={},Ne(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}I0(o,s)}}}},Be=ks.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)Se?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",headless:1,init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Va("roundProps",Do),Va("modifiers"),Va("snap",Ku))||ks;he.version=Ce.version=Be.version="3.13.0";Uu=1;Jo()&&xr();Nt.Power0;Nt.Power1;Nt.Power2;Nt.Power3;Nt.Power4;Nt.Linear;Nt.Quad;Nt.Cubic;Nt.Quart;Nt.Quint;Nt.Strong;Nt.Elastic;Nt.Back;Nt.SteppedEase;Nt.Bounce;Nt.Sine;Nt.Expo;Nt.Circ;/*!
 * CSSPlugin 3.13.0
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Cc,$n,lr,ul,Ei,Pc,hl,N0=function(){return typeof window<"u"},Bn={},gi=180/Math.PI,cr=Math.PI/180,tr=Math.atan2,Lc=1e8,fl=/([A-Z])/g,F0=/(left|right|width|margin|padding|x)/i,O0=/[\s,\(]\S/,xn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},No=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},B0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},z0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},V0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},mh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},_h=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},H0=function(t,e,n){return t.style[e]=n},k0=function(t,e,n){return t.style.setProperty(e,n)},G0=function(t,e,n){return t._gsap[e]=n},W0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},X0=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},q0=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},te="transform",Oe=te+"Origin",Y0=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in Bn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=xn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Dn(i,o)}):this.tfm[t]=a.x?a[t]:Dn(i,t),t===Oe&&(this.tfm.zOrigin=a.zOrigin);else return xn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(te)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Oe,e,"")),t=te}(s||e)&&this.props.push(t,e,s[t])},gh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},K0=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(fl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=hl(),(!s||!s.isStart)&&!n[te]&&(gh(n),i.zOrigin&&n[Oe]&&(n[Oe]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},vh=function(t,e){var n={target:t,props:[],revert:K0,save:Y0};return t._gsap||Be.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},xh,Fo=function(t,e){var n=$n.createElementNS?$n.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):$n.createElement(t);return n&&n.style?n:$n.createElement(t)},nn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(fl,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Mr(e)||e,1)||""},Dc="O,Moz,ms,Ms,Webkit".split(","),Mr=function(t,e,n){var i=e||Ei,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Dc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Dc[a]:"")+t},Oo=function(){N0()&&window.document&&(Cc=window,$n=Cc.document,lr=$n.documentElement,Ei=Fo("div")||{style:{}},Fo("div"),te=Mr(te),Oe=te+"Origin",Ei.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",xh=!!Mr("perspective"),hl=Be.core.reverting,ul=1)},Uc=function(t){var e=t.ownerSVGElement,n=Fo("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),lr.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),lr.removeChild(n),s},Ic=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Mh=function(t){var e,n;try{e=t.getBBox()}catch{e=Uc(t),n=1}return e&&(e.width||e.height)||n||(e=Uc(t)),e&&!e.width&&!e.x&&!e.y?{x:+Ic(t,["x","cx","x1"])||0,y:+Ic(t,["y","cy","y1"])||0,width:0,height:0}:e},Sh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Mh(t))},Pi=function(t,e){if(e){var n=t.style,i;e in Bn&&e!==Oe&&(e=te),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(fl,"-$1").toLowerCase())):n.removeAttribute(e)}},Zn=function(t,e,n,i,s,a){var o=new Fe(t._pt,e,n,0,1,a?_h:mh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Nc={deg:1,rad:1,turn:1},$0={grid:1,flex:1},ii=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ei.style,l=F0.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",m=i==="%",g,_,d,p;if(i===a||!s||Nc[i]||Nc[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),p=t.getCTM&&Sh(t),(m||a==="%")&&(Bn[e]||~e.indexOf("adius")))return g=p?t.getBBox()[l?"width":"height"]:t[u],se(m?s/g*h:s/100*g);if(o[l?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,p&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===$n||!_.appendChild)&&(_=$n.body),d=_._gsap,d&&m&&d.width&&l&&d.time===Xe.time&&!d.uncache)return se(s/d.width*h);if(m&&(e==="height"||e==="width")){var E=t.style[e];t.style[e]=h+i,g=t[u],E?t.style[e]=E:Pi(t,e)}else(m||a==="%")&&!$0[nn(_,"display")]&&(o.position=nn(t,"position")),_===t&&(o.position="static"),_.appendChild(Ei),g=Ei[u],_.removeChild(Ei),o.position="absolute";return l&&m&&(d=Ai(_),d.time=Xe.time,d.width=_[u]),se(f?g*s/h:g&&s?h/g*s:0)},Dn=function(t,e,n,i){var s;return ul||Oo(),e in xn&&e!=="transform"&&(e=xn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Bn[e]&&e!=="transform"?(s=kr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Ws(nn(t,Oe))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Gs[e]&&Gs[e](t,e,n)||nn(t,e)||Ou(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ii(t,e,s,n)+n:s},Z0=function(t,e,n,i){if(!n||n==="none"){var s=Mr(e,t,1),a=s&&nn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=nn(t,"borderTopColor"))}var o=new Fe(this._pt,t.style,e,0,1,fh),l=0,c=0,u,h,f,m,g,_,d,p,E,x,T,R;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=nn(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=nn(t,e)||i,_?t.style[e]=_:Pi(t,e)),u=[n,i],nh(u),n=u[0],i=u[1],f=n.match(nr)||[],R=i.match(nr)||[],R.length){for(;h=nr.exec(i);)d=h[0],E=i.substring(l,h.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),d!==(_=f[c++]||"")&&(m=parseFloat(_)||0,T=_.substr((m+"").length),d.charAt(1)==="="&&(d=or(m,d)+T),p=parseFloat(d),x=d.substr((p+"").length),l=nr.lastIndex-x.length,x||(x=x||Ke.units[e]||T,l===i.length&&(i+=x,o.e+=x)),T!==x&&(m=ii(t,e,_,x)||0),o._pt={_next:o._pt,p:E||c===1?E:",",s:m,c:p-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?_h:mh;return Lu.test(i)&&(o.e=0),this._pt=o,o},Fc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},j0=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Fc[n]||n,e[1]=Fc[i]||i,e.join(" ")},J0=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Bn[o]&&(l=1,o=o==="transformOrigin"?Oe:te),Pi(n,o);l&&(Pi(n,te),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",kr(n,1),a.uncache=1,gh(i)))}},Gs={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Fe(t._pt,e,n,0,0,J0);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Hr=[1,0,0,1,0,0],yh={},Eh=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Oc=function(t){var e=nn(t,te);return Eh(e)?Hr:e.substr(7).match(Pu).map(se)},dl=function(t,e){var n=t._gsap||Ai(t),i=t.style,s=Oc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Hr:s):(s===Hr&&!t.offsetParent&&t!==lr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,lr.appendChild(t)),s=Oc(t),l?i.display=l:Pi(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):lr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Bo=function(t,e,n,i,s,a){var o=t._gsap,l=s||dl(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,m=l[0],g=l[1],_=l[2],d=l[3],p=l[4],E=l[5],x=e.split(" "),T=parseFloat(x[0])||0,R=parseFloat(x[1])||0,A,b,P,v;n?l!==Hr&&(b=m*d-g*_)&&(P=T*(d/b)+R*(-_/b)+(_*E-d*p)/b,v=T*(-g/b)+R*(m/b)-(m*E-g*p)/b,T=P,R=v):(A=Mh(t),T=A.x+(~x[0].indexOf("%")?T/100*A.width:T),R=A.y+(~(x[1]||x[0]).indexOf("%")?R/100*A.height:R)),i||i!==!1&&o.smooth?(p=T-c,E=R-u,o.xOffset=h+(p*m+E*_)-p,o.yOffset=f+(p*g+E*d)-E):o.xOffset=o.yOffset=0,o.xOrigin=T,o.yOrigin=R,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Oe]="0px 0px",a&&(Zn(a,o,"xOrigin",c,T),Zn(a,o,"yOrigin",u,R),Zn(a,o,"xOffset",h,o.xOffset),Zn(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",T+" "+R)},kr=function(t,e){var n=t._gsap||new ah(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=nn(t,Oe)||"0",u,h,f,m,g,_,d,p,E,x,T,R,A,b,P,v,M,L,z,N,G,X,H,Y,k,at,ot,ht,bt,zt,W,j;return u=h=f=_=d=p=E=x=T=0,m=g=1,n.svg=!!(t.getCTM&&Sh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[te]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[te]!=="none"?l[te]:"")),i.scale=i.rotate=i.translate="none"),b=dl(t,n.svg),n.svg&&(n.uncache?(k=t.getBBox(),c=n.xOrigin-k.x+"px "+(n.yOrigin-k.y)+"px",Y=""):Y=!e&&t.getAttribute("data-svg-origin"),Bo(t,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,b)),R=n.xOrigin||0,A=n.yOrigin||0,b!==Hr&&(L=b[0],z=b[1],N=b[2],G=b[3],u=X=b[4],h=H=b[5],b.length===6?(m=Math.sqrt(L*L+z*z),g=Math.sqrt(G*G+N*N),_=L||z?tr(z,L)*gi:0,E=N||G?tr(N,G)*gi+_:0,E&&(g*=Math.abs(Math.cos(E*cr))),n.svg&&(u-=R-(R*L+A*N),h-=A-(R*z+A*G))):(j=b[6],zt=b[7],ot=b[8],ht=b[9],bt=b[10],W=b[11],u=b[12],h=b[13],f=b[14],P=tr(j,bt),d=P*gi,P&&(v=Math.cos(-P),M=Math.sin(-P),Y=X*v+ot*M,k=H*v+ht*M,at=j*v+bt*M,ot=X*-M+ot*v,ht=H*-M+ht*v,bt=j*-M+bt*v,W=zt*-M+W*v,X=Y,H=k,j=at),P=tr(-N,bt),p=P*gi,P&&(v=Math.cos(-P),M=Math.sin(-P),Y=L*v-ot*M,k=z*v-ht*M,at=N*v-bt*M,W=G*M+W*v,L=Y,z=k,N=at),P=tr(z,L),_=P*gi,P&&(v=Math.cos(P),M=Math.sin(P),Y=L*v+z*M,k=X*v+H*M,z=z*v-L*M,H=H*v-X*M,L=Y,X=k),d&&Math.abs(d)+Math.abs(_)>359.9&&(d=_=0,p=180-p),m=se(Math.sqrt(L*L+z*z+N*N)),g=se(Math.sqrt(H*H+j*j)),P=tr(X,H),E=Math.abs(P)>2e-4?P*gi:0,T=W?1/(W<0?-W:W):0),n.svg&&(Y=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Eh(nn(t,te)),Y&&t.setAttribute("transform",Y))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(m*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=se(m),n.scaleY=se(g),n.rotation=se(_)+o,n.rotationX=se(d)+o,n.rotationY=se(p)+o,n.skewX=E+o,n.skewY=x+o,n.transformPerspective=T+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Oe]=Ws(c)),n.xOffset=n.yOffset=0,n.force3D=Ke.force3D,n.renderTransform=n.svg?tv:xh?Th:Q0,n.uncache=0,n},Ws=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ha=function(t,e,n){var i=Te(e);return se(parseFloat(e)+parseFloat(ii(t,"x",n+"px",i)))+i},Q0=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Th(t,e)},di="0deg",Rr="0px",pi=") ",Th=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,d=n.transformPerspective,p=n.force3D,E=n.target,x=n.zOrigin,T="",R=p==="auto"&&t&&t!==1||p===!0;if(x&&(h!==di||u!==di)){var A=parseFloat(u)*cr,b=Math.sin(A),P=Math.cos(A),v;A=parseFloat(h)*cr,v=Math.cos(A),a=Ha(E,a,b*v*-x),o=Ha(E,o,-Math.sin(A)*-x),l=Ha(E,l,P*v*-x+x)}d!==Rr&&(T+="perspective("+d+pi),(i||s)&&(T+="translate("+i+"%, "+s+"%) "),(R||a!==Rr||o!==Rr||l!==Rr)&&(T+=l!==Rr||R?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+pi),c!==di&&(T+="rotate("+c+pi),u!==di&&(T+="rotateY("+u+pi),h!==di&&(T+="rotateX("+h+pi),(f!==di||m!==di)&&(T+="skew("+f+", "+m+pi),(g!==1||_!==1)&&(T+="scale("+g+", "+_+pi),E.style[te]=T||"translate(0, 0)"},tv=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,d=n.xOffset,p=n.yOffset,E=n.forceCSS,x=parseFloat(a),T=parseFloat(o),R,A,b,P,v;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=cr,c*=cr,R=Math.cos(l)*h,A=Math.sin(l)*h,b=Math.sin(l-c)*-f,P=Math.cos(l-c)*f,c&&(u*=cr,v=Math.tan(c-u),v=Math.sqrt(1+v*v),b*=v,P*=v,u&&(v=Math.tan(u),v=Math.sqrt(1+v*v),R*=v,A*=v)),R=se(R),A=se(A),b=se(b),P=se(P)):(R=h,P=f,A=b=0),(x&&!~(a+"").indexOf("px")||T&&!~(o+"").indexOf("px"))&&(x=ii(m,"x",a,"px"),T=ii(m,"y",o,"px")),(g||_||d||p)&&(x=se(x+g-(g*R+_*b)+d),T=se(T+_-(g*A+_*P)+p)),(i||s)&&(v=m.getBBox(),x=se(x+i/100*v.width),T=se(T+s/100*v.height)),v="matrix("+R+","+A+","+b+","+P+","+x+","+T+")",m.setAttribute("transform",v),E&&(m.style[te]=v)},ev=function(t,e,n,i,s){var a=360,o=ve(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?gi:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-360)),h==="cw"&&c<0?c=(c+a*Lc)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Lc)%a-~~(c/a)*a)),t._pt=f=new Fe(t._pt,e,n,i,c,B0),f.e=u,f.u="deg",t._props.push(n),f},Bc=function(t,e){for(var n in e)t[n]=e[n];return t},nv=function(t,e,n){var i=Bc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[te]=e,o=kr(n,1),Pi(n,te),n.setAttribute("transform",c)):(c=getComputedStyle(n)[te],a[te]=e,o=kr(n,1),a[te]=c);for(l in Bn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(m=Te(c),g=Te(u),h=m!==g?ii(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new Fe(t._pt,o,l,h,f-h,No),t._pt.u=g||0,t._props.push(l));Bc(o,i)};Ne("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Gs[t>1?"border"+r:r]=function(o,l,c,u,h){var f,m;if(arguments.length<4)return f=a.map(function(g){return Dn(o,g,c)}),m=f.join(" "),m.split(f[0]).length===5?f[0]:m;f=(u+"").split(" "),m={},a.forEach(function(g,_){return m[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,m,h)}});var Ah={name:"css",register:Oo,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,h,f,m,g,_,d,p,E,x,T,R,A,b,P;ul||Oo(),this.styles=this.styles||vh(t),P=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(We[_]&&oh(_,e,n,i,t,s)))){if(m=typeof u,g=Gs[_],m==="function"&&(u=u.call(n,i,t,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=Br(u)),g)g(this,t,_,u,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ti.lastIndex=0,ti.test(c)||(d=Te(c),p=Te(u)),p?d!==p&&(c=ii(t,_,c,p)+p):d&&(u+=d),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),P.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],ve(c)&&~c.indexOf("random(")&&(c=Br(c)),Te(c+"")||c==="auto"||(c+=Ke.units[_]||Te(Dn(t,_))||""),(c+"").charAt(1)==="="&&(c=Dn(t,_))):c=Dn(t,_),f=parseFloat(c),E=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),E&&(u=u.substr(2)),h=parseFloat(u),_ in xn&&(_==="autoAlpha"&&(f===1&&Dn(t,"visibility")==="hidden"&&h&&(f=0),P.push("visibility",0,o.visibility),Zn(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=xn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Bn,x){if(this.styles.save(_),m==="string"&&u.substring(0,6)==="var(--"&&(u=nn(t,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),T||(R=t._gsap,R.renderTransform&&!e.parseTransform||kr(t,e.parseTransform),A=e.smoothOrigin!==!1&&R.smooth,T=this._pt=new Fe(this._pt,o,te,0,1,R.renderTransform,R,0,-1),T.dep=1),_==="scale")this._pt=new Fe(this._pt,R,"scaleY",R.scaleY,(E?or(R.scaleY,E+h):h)-R.scaleY||0,No),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){P.push(Oe,0,o[Oe]),u=j0(u),R.svg?Bo(t,u,0,A,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==R.zOrigin&&Zn(this,R,"zOrigin",R.zOrigin,p),Zn(this,o,_,Ws(c),Ws(u)));continue}else if(_==="svgOrigin"){Bo(t,u,1,A,0,this);continue}else if(_ in yh){ev(this,R,_,f,E?or(f,E+u):u);continue}else if(_==="smoothOrigin"){Zn(this,R,"smooth",R.smooth,u);continue}else if(_==="force3D"){R[_]=u;continue}else if(_==="transform"){nv(this,u,t);continue}}else _ in o||(_=Mr(_)||_);if(x||(h||h===0)&&(f||f===0)&&!O0.test(u)&&_ in o)d=(c+"").substr((f+"").length),h||(h=0),p=Te(u)||(_ in Ke.units?Ke.units[_]:d),d!==p&&(f=ii(t,_,c,p)),this._pt=new Fe(this._pt,x?R:o,_,f,(E?or(f,E+h):h)-f,!x&&(p==="px"||_==="zIndex")&&e.autoRound!==!1?V0:No),this._pt.u=p||0,d!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=z0);else if(_ in o)Z0.call(this,t,_,c,E?E+u:u);else if(_ in t)this.add(t,_,c||t[_],E?E+u:u,i,s);else if(_!=="parseTransform"){tl(_,u);continue}x||(_ in o?P.push(_,0,o[_]):typeof t[_]=="function"?P.push(_,2,t[_]()):P.push(_,1,c||t[_])),a.push(_)}}b&&dh(this)},render:function(t,e){if(e.tween._time||!hl())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Dn,aliases:xn,getSetter:function(t,e,n){var i=xn[e];return i&&i.indexOf(",")<0&&(e=i),e in Bn&&e!==Oe&&(t._gsap.x||Dn(t,"x"))?n&&Pc===n?e==="scale"?W0:G0:(Pc=n||{})&&(e==="scale"?X0:q0):t.style&&!jo(t.style[e])?H0:~e.indexOf("-")?k0:ll(t,e)},core:{_removeProperty:Pi,_getMatrix:dl}};Be.utils.checkPrefix=Mr;Be.core.getStyleSaver=vh;(function(r,t,e,n){var i=Ne(r+","+t+","+e,function(s){Bn[s]=1});Ne(t,function(s){Ke.units[s]="deg",yh[s]=1}),xn[i[13]]=r+","+t,Ne(n,function(s){var a=s.split(":");xn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ne("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ke.units[r]="px"});Be.registerPlugin(Ah);var zo=Be.registerPlugin(Ah)||Be;zo.core.Tween;const zc=["#FF9E30","#00FF00","#FF0000","#007BFF"];function iv(r){const t=r.textContent;r.innerHTML="",[...t].forEach((e,n)=>{const i=document.createElement("span");i.textContent=e,i.style.display="inline-block",i.style.transition="color 0.3s ease",r.appendChild(i)})}window.addEventListener("DOMContentLoaded",()=>{const r=document.querySelectorAll("body *:not(nav):not(nav *)"),t=[];r.forEach(e=>{e.children.length===0&&e.textContent.trim()!==""&&t.push(e)}),t.forEach(e=>{iv(e),e.querySelectorAll("span").forEach((i,s)=>{i.addEventListener("mouseenter",()=>{const a=zc[s%zc.length];zo.to(i,{color:a,duration:.01,ease:"power1.out"})}),i.addEventListener("mouseleave",()=>{zo.to(i,{color:"",duration:.2,ease:"power1.out"})})})})});
//# sourceMappingURL=main-BM1RO7cW.js.map
